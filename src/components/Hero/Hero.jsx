...
const ImageList = [
    {
        ...
        description:
            "lorem His Life will forever be Changed dolor sit amet, consecteur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. "
    },
    {
        id: 2,
        img: Image2,
...
{ImageList.map((data) => (
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2">
     ...
     <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
         <h1 
         data-aos="zoom-out"
         ...
         <div
          ...
          >
             ...
             text-xhite py-2 px-4 rounded-full">Order Now</button>
         </div>
     </div>
     {/* image section */}
     <div className="order-1 sm:order-2">
         <div className="relative z-10">
             <img src={data.img} alt=""
              ...
              sm:w-[450px] sm:scale-125 lg:scale-120 object-contain mx-auto" />
         </div>
     </div>
 </div>
</div>
